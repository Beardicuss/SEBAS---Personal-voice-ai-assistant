...
class SimpleNLU:
    ...
    def __init__(self):
        ...
        self.patterns: List[Tuple[str, str, float]] = [
            ...
            # Stage 2: Advanced system commands
            (r"list services", "list_services", 0.95),
            (r"(get |show |check )?defender status", "get_defender_status", 0.95),
            (r"(get |show |check )?system performance", "get_system_performance", 0.95),
